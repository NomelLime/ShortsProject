"""
pipeline/contexts/rutube.py - Desktop context for RuTube.
"""
...
class RutubeContext(BasePlatformContext):
    ...
    def get_login_url(self) -> str:
        return "https://rutube.ru/login/"

    def get_session_check_url(self) -> str:
        return "https://rutube.ru/profile/video/"

    def get_redirect_markers(self) -> List[str]:
        return ["rutube.ru/login", "rutube.ru/auth"]
