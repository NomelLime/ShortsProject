"""
pipeline/contexts/ok.py - Desktop context for Odnoklassniki video.
"""
...
class OkContext(BasePlatformContext):
    platform_name = "ok"
    ...
    def get_session_check_url(self) -> str:
        return "https://ok.ru/video"

    def get_redirect_markers(self) -> List[str]:
        return ["connect.ok.ru", "ok.ru/dk?st.cmd=anonymMain"]
