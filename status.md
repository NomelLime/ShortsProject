...
- **Интеграционные / E2E тесты** — юниты агентного слоя + smoke Director/Commander/Crew (`test_orchestrator.py`) есть; без моков не покрыты Visionary, Narrator, Editor, полный жизненный цикл `run_crew.py`, E2E классического пайплайна
